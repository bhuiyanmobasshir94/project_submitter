                 ...
                 <div class="border">
                     <h3 style="text-align:center;color: #0c4da2; font-weight: 600;">PROJECT UPDATE WINDOW</h3>
                   ...
                   <?php 
                       ...
                       //  if(isset($_REQUEST['Ccode'])){ $_SESSION['ccode'] = $_REQUEST['Ccode']; assign($_SESSION['ccode']); }
                         if(isset($_REQUEST['status'])){  $id = $_SESSION['id'];$ccode = $_SESSION['du']; updateProject($id,$ccode); }
