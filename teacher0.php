            ...
            <div class="panel-group wrap" id="bs-collapse">
                ...
                <div class="panel">
                    ...
                    <div id="one" class="panel-collapse collapse">
                        ...
                        <div class="form-group">
                            <input class="form-control"  id="groupmember" name="Member" placeholder="Group Member [atmost 4]" type="text" required/>
                            <!--NEED MODIFICATION-->
                            <span class="field-validation-valid"></span>
                        </div>
                        <div class="row">
                ...
                $sql = "SELECT Ccode FROM courseassigned WHERE Tid ='$id'";
                ...
                ?>
                        <input type="button" class="btn btn-block btn-primary p-lg-left-right" value="<?php echo $row[$i]-> Ccode; ?>" onclick="alert(this.value)">
                <?php
                }
                ?>                    
                        </div>
